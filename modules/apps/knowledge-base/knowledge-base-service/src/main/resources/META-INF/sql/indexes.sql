...
create index IX_74310E2 on KBArticle (companyId, latest, status, ctCollectionId);
create index IX_CBFFCEEE on KBArticle (companyId, main, ctCollectionId);
create index IX_92A5F1D4 on KBArticle (companyId, main, status, ctCollectionId);
...
create index IX_15FD63B8 on KBArticle (groupId, kbFolderId, latest, status, ctCollectionId);
...
create index IX_98568C24 on KBArticle (groupId, latest, status, ctCollectionId);
create index IX_471614B0 on KBArticle (groupId, main, ctCollectionId);
create index IX_65835596 on KBArticle (groupId, main, status, ctCollectionId);
...
create index IX_378D34A1 on KBArticle (groupId, status, parentResourcePrimKey, latest);
create index IX_60503053 on KBArticle (groupId, status, parentResourcePrimKey, main);
create index IX_21AFD730 on KBArticle (groupId, status, resourcePrimKey);
...
create index IX_F34168B on KBArticle (parentResourcePrimKey, latest, status, ctCollectionId);
create index IX_C4E323D7 on KBArticle (parentResourcePrimKey, main, ctCollectionId);
create index IX_5F3E4DBD on KBArticle (parentResourcePrimKey, main, status, ctCollectionId);
...
create index IX_7874AB93 on KBArticle (resourcePrimKey, groupId, latest, status, ctCollectionId);
create index IX_3DE0E2DF on KBArticle (resourcePrimKey, groupId, main, ctCollectionId);
create index IX_3C3084C5 on KBArticle (resourcePrimKey, groupId, main, status, ctCollectionId);
...
create index IX_5CD6ECD5 on KBArticle (resourcePrimKey, latest, status, ctCollectionId);
create index IX_14E56EA1 on KBArticle (resourcePrimKey, main, ctCollectionId);
create index IX_53562E87 on KBArticle (resourcePrimKey, main, status, ctCollectionId);
...
create index IX_94928E30 on KBArticle (status, resourcePrimKey);
