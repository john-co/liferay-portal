...
public class CPDefinitionVirtualSettingPersistenceImpl
	...
	/**
	 * Returns all the cp definition virtual settings where fileEntryId = &#63;.
	 *
	 * @param fileEntryId the file entry ID
	 * @return the matching cp definition virtual settings
	 */
	@Override
	public List<CPDefinitionVirtualSetting> findByFileEntryId(
		long fileEntryId) {
	...
	/**
	 * Returns a range of all the cp definition virtual settings where fileEntryId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>CPDefinitionVirtualSettingModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the cp definition virtual settings where fileEntryId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>CPDefinitionVirtualSettingModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns the first cp definition virtual setting in the ordered set where fileEntryId = &#63;.
	 *
	 * @param fileEntryId the file entry ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching cp definition virtual setting
	 ...
	 */
	@Override
	public CPDefinitionVirtualSetting findByFileEntryId_First(
			long fileEntryId,
			OrderByComparator<CPDefinitionVirtualSetting> orderByComparator)
		throws NoSuchCPDefinitionVirtualSettingException {
	 ...
	 */
	@Override
	public CPDefinitionVirtualSetting fetchByFileEntryId_First(
		long fileEntryId,
		OrderByComparator<CPDefinitionVirtualSetting> orderByComparator) {

		List<CPDefinitionVirtualSetting> list = findByFileEntryId(
	...
	/**
	 * Returns the last cp definition virtual setting in the ordered set where fileEntryId = &#63;.
	 *
	 * @param fileEntryId the file entry ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching cp definition virtual setting
	 ...
	 */
	@Override
	public CPDefinitionVirtualSetting findByFileEntryId_Last(
			long fileEntryId,
			OrderByComparator<CPDefinitionVirtualSetting> orderByComparator)
		throws NoSuchCPDefinitionVirtualSettingException {
	 ...
	 */
	@Override
	public CPDefinitionVirtualSetting fetchByFileEntryId_Last(
		long fileEntryId,
		OrderByComparator<CPDefinitionVirtualSetting> orderByComparator) {
	...
	/**
	 * Returns the cp definition virtual settings before and after the current cp definition virtual setting in the ordered set where fileEntryId = &#63;.
	 *
	 * @param CPDefinitionVirtualSettingId the primary key of the current cp definition virtual setting
	 * @param fileEntryId the file entry ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public CPDefinitionVirtualSetting[] findByFileEntryId_PrevAndNext(
		...
		try {
			...
			array[0] = getByFileEntryId_PrevAndNext(
				session, cpDefinitionVirtualSetting, fileEntryId,
				orderByComparator, true);
	...
	protected CPDefinitionVirtualSetting getByFileEntryId_PrevAndNext(
		Session session, CPDefinitionVirtualSetting cpDefinitionVirtualSetting,
		long fileEntryId,
		OrderByComparator<CPDefinitionVirtualSetting> orderByComparator,
		boolean previous) {
	...
	/**
	 * Removes all the cp definition virtual settings where fileEntryId = &#63; from the database.
	 *
	 * @param fileEntryId the file entry ID
	 */
	@Override
	...
	/**
	 * Returns the number of cp definition virtual settings where fileEntryId = &#63;.
	 *
	 * @param fileEntryId the file entry ID
	 * @return the number of matching cp definition virtual settings
	 */
	...
	private static final String _FINDER_COLUMN_FILEENTRYID_FILEENTRYID_2 =
		"cpDefinitionVirtualSetting.fileEntryId = ?";
