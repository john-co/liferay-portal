...
package com.liferay.commerce.product.type.virtual.internal.upgrade.v2_0_1;
	...
	protected void doUpgrade() throws Exception {
		...
		try (PreparedStatement preparedStatement1 = connection.prepareStatement(
				StringBundler.concat(
					...
					"CPDefinitionVirtualSetting.fileEntryId from Group_ inner ",
					"join CPDefinitionVirtualSetting on Group_.groupId = ",
