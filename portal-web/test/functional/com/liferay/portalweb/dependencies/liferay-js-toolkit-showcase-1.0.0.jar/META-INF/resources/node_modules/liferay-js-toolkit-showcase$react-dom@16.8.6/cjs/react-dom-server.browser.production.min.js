...
'use strict';
Liferay.Loader.define("liferay-js-toolkit-showcase$react-dom@16.8.6/cjs/react-dom-server.browser.production.min", ['module', 'exports', 'require', 'liferay-js-toolkit-showcase$object-assign', 'liferay-js-toolkit-showcase$react'], function (module, exports, require) {
  var define = undefined;
  var p = require("liferay-js-toolkit-showcase$object-assign"),
      q = require("liferay-js-toolkit-showcase$react");function aa(a, b, d, c, f, e, h, g) {
    if (!a) {
  ...
  function r(a) {
    for (var b = arguments.length - 1, d = "https://reactjs.org/docs/error-decoder.html?invariant=" + a, c = 0; c < b; c++) d += "&args[]=" + encodeURIComponent(arguments[c + 1]);aa(!1, "Minified React error #" + a + "; visit %s for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ", d);
  }
  ...
  function C(a) {
    if (null == a) return null;if ("function" === typeof a) return a.displayName || a.name || null;if ("string" === typeof a) return a;switch (a) {case fa:
        return "ConcurrentMode";case x:
        return "Fragment";case ba:
        return "Portal";case da:
        return "Profiler";case ca:
        return "StrictMode";case A:
        return "Suspense";}if ("object" === typeof a) switch (a.$$typeof) {case ea:
        return "Context.Consumer";case z:
        return "Context.Provider";case ha:
        var b = a.render;b = b.displayName || b.name || "";return a.displayName || ("" !== b ? "ForwardRef(" + b + ")" : "ForwardRef");case ia:
        return C(a.type);case ja:
        if (a = 1 === a._status ? a._result : null) return C(a);}return null;
  }var E = q.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;E.hasOwnProperty("ReactCurrentDispatcher") || (E.ReactCurrentDispatcher = { current: null });var ka = {};function F(a, b) {
  ...
  }for (var G = new Uint16Array(16), H = 0; 15 > H; H++) G[H] = H + 1;G[15] = 0;
  var ma = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,
      na = Object.prototype.hasOwnProperty,
      oa = {},
      pa = {};
  function qa(a) {
    if (na.call(pa, a)) return !0;if (na.call(oa, a)) return !1;if (ma.test(a)) return pa[a] = !0;oa[a] = !0;return !1;
  }function ra(a, b, d, c) {
  ...
  function sa(a, b, d, c) {
    if (null === b || "undefined" === typeof b || ra(a, b, d, c)) return !0;if (c) return !1;if (null !== d) switch (d.type) {case 3:
        return !b;case 4:
        return !1 === b;case 5:
  ...
  function M(a) {
    if ("boolean" === typeof a || "number" === typeof a) return "" + a;a = "" + a;var b = ta.exec(a);if (b) {
      var d = "",
          c,
  ...
  function ua() {
    ...
    null === P ? null === O ? (Q = !1, O = P = ua()) : (Q = !0, P = O) : null === P.next ? (Q = !1, P = P.next = ua()) : (Q = !0, P = P.next);return P;
  }function va(a, b, d, c) {
    for (; S;) S = !1, U += 1, P = null, d = a(b, c);O = N = null;U = 0;P = T = null;return d;
  }function wa(a, b) {
  ...
  function xa(a, b, d) {
    N = V();P = W();if (Q) {
      var c = P.queue;b = c.dispatch;if (null !== T && (d = T.get(c), void 0 !== d)) {
        T.delete(c);c = P.memoizedState;do c = a(c, d.action), d = d.next; while (null !== d);P.memoizedState = c;return [c, b];
      }return [P.memoizedState, b];
    }a = a === wa ? "function" === typeof b ? b() : b : void 0 !== d ? d(b) : b;P.memoizedState = a;a = P.queue = { last: null, dispatch: null };a = a.dispatch = ya.bind(null, N, a);return [P.memoizedState, a];
  }
  function ya(a, b, d) {
  ...
  var X = 0,
    ...
    }, useReducer: xa, useRef: function (a) {
      N = V();P = W();var b = P.memoizedState;
      return null === b ? (a = { current: a }, P.memoizedState = a) : b;
    }, useState: function (a) {
      return xa(wa, a);
    }, useLayoutEffect: function () {}, useCallback: function (a) {
      return a;
    }, useImperativeHandle: za, useEffect: za, useDebugValue: za },
      Ba = { html: "http://www.w3.org/1999/xhtml", mathml: "http://www.w3.org/1998/Math/MathML", svg: "http://www.w3.org/2000/svg" };function Ca(a) {
    switch (a) {case "svg":
        return "http://www.w3.org/2000/svg";case "math":
        return "http://www.w3.org/1998/Math/MathML";default:
        return "http://www.w3.org/1999/xhtml";}
  }
  var Da = { area: !0, base: !0, br: !0, col: !0, embed: !0, hr: !0, img: !0, input: !0, keygen: !0, link: !0, meta: !0, param: !0, source: !0, track: !0, wbr: !0 },
      Ea = p({ menuitem: !0 }, Da),
    ...
    gridColumnStart: !0, fontWeight: !0, lineClamp: !0, lineHeight: !0, opacity: !0, order: !0, orphans: !0, tabSize: !0, widows: !0, zIndex: !0, zoom: !0, fillOpacity: !0, floodOpacity: !0, stopOpacity: !0, strokeDasharray: !0, strokeDashoffset: !0, strokeMiterlimit: !0, strokeOpacity: !0, strokeWidth: !0 },
      Fa = ["Webkit", "ms", "Moz", "O"];Object.keys(Y).forEach(function (a) {
  ...
  var Ga = /([A-Z])/g,
    ...
    if (void 0 === a || null === a) return a;var b = "";q.Children.forEach(a, function (a) {
      ...
      Pa = { children: null, dangerouslySetInnerHTML: null, suppressContentEditableWarning: null, suppressHydrationWarning: null };function Qa(a, b) {
  ...
  function Ra(a, b, d) {
    function c(c, f) {
      ...
      } else g = null;a = k.render();Qa(a, f);c = void 0;if ("function" === typeof k.getChildContext && (e = f.childContextTypes, "object" === typeof e)) {
        c = k.getChildContext();for (var R in c) R in e ? void 0 : r("108", C(f) || "Unknown", R);
      }c && (b = p({}, b, c));
  ...
  var Sa = function () {
    function a(b, d) {
      if (!(this instanceof a)) throw new TypeError("Cannot call a class as a function");q.isValidElement(b) ? b.type !== x ? b = [b] : (b = b.props.children, b = q.isValidElement(b) ? [b] : Z(b)) : b = Z(b);b = { type: null, domNamespace: Ba.html, children: b, childIndex: 0, context: ka, footer: "" };var c = G[0];if (0 === c) {
        var f = G;c = f.length;var e = 2 * c;65536 >= e ? void 0 : r("304");var h = new Uint16Array(e);h.set(f);G = h;G[0] = c + 1;for (f = c; f < e - 1; f++) G[f] = f + 1;G[e - 1] = 0;
      ...
      if (this.exhausted) return null;var b = X;X = this.threadID;var c = Ia.current;Ia.current = Aa;try {
      ...
      }d = Ra(a, d, this.threadID);a = d.child;d = d.context;
      if (null === a || !1 === a) return "";if (!q.isValidElement(a)) {
        if (null != a && null != a.$$typeof) {
          var b = a.$$typeof;b === ba ? r("257") : void 0;r("258", b.toString());
        }a = Z(a);this.stack.push({ type: null, domNamespace: c, children: a, childIndex: 0, context: d, footer: "" });return "";
      }b = a.type;if ("string" === typeof b) return this.renderDOM(a, d, c);switch (b) {case ca:case fa:case da:case x:
          return a = Z(a.props.children), this.stack.push({ type: null, domNamespace: c, children: a, childIndex: 0, context: d, footer: "" }), "";case A:
          r("294");}if ("object" === typeof b && null !== b) switch (b.$$typeof) {case ha:
          N = {};var e = b.render(a.props, a.ref);e = va(b.render, a.props, e, a.ref);e = Z(e);this.stack.push({ type: null, domNamespace: c, children: e, childIndex: 0, context: d, footer: "" });return "";case ia:
          ...
          return b = Z(a.props.children), c = { type: a, domNamespace: c, children: b, childIndex: 0, context: d, footer: "" }, this.pushProvider(a), this.stack.push(c), "";case ea:
          b = a.type;e = a.props;var h = this.threadID;F(b, h);b = Z(e.children(b[h]));this.stack.push({ type: a, domNamespace: c, children: b, childIndex: 0, context: d, footer: "" });return "";case ja:
          r("295");}r("130", null == b ? b : typeof b, "");
    };a.prototype.renderDOM = function (a, d, c) {
      var b = a.type.toLowerCase();c === Ba.html && Ca(b);La.hasOwnProperty(b) || (Ka.test(b) ? void 0 : r("65", b), La[b] = !0);var e = a.props;if ("input" === b) e = p({ type: void 0 }, e, { defaultChecked: void 0, defaultValue: void 0, value: null != e.value ? e.value : e.defaultValue,
        ...
        g = this.currentSelectValue;var D = Na(e.children);if (null != g) {
      ...
      }if (h = e) Ea[b] && (null != h.children || null != h.dangerouslySetInnerHTML ? r("137", b, "") : void 0), null != h.dangerouslySetInnerHTML && (null != h.children ? r("60") : void 0, "object" === typeof h.dangerouslySetInnerHTML && "__html" in h.dangerouslySetInnerHTML ? void 0 : r("61")), null != h.style && "object" !== typeof h.style ? r("62", "") : void 0;h = e;g = this.makeStaticMarkup;
      D = 1 === this.stack.length;B = "<" + a.type;for (y in h) if (Oa.call(h, y)) {
        var l = h[y];if (null != l) {
          if ("style" === y) {
            n = void 0;var k = "",
                t = "";for (n in l) if (l.hasOwnProperty(n)) {
              var m = 0 === n.indexOf("--"),
                  u = l[n];if (null != u) {
                var w = n;if (Ma.hasOwnProperty(w)) w = Ma[w];else {
                  var R = w.replace(Ga, "-$1").toLowerCase().replace(Ha, "-ms-");w = Ma[w] = R;
              ...
              m = !1;break b;default:
              m = !0;}if (m) Pa.hasOwnProperty(y) || (n = y, n = qa(n) && null != l ? n + "=" + ('"' + M(l) + '"') : "");else {
            m = y;n = l;l = J.hasOwnProperty(m) ? J[m] : null;if (u = "style" !== m) u = null !== l ? 0 === l.type : !(2 < m.length) || "o" !== m[0] && "O" !== m[0] || "n" !== m[1] && "N" !== m[1] ? !1 : !0;u || sa(m, n, l, !1) ? n = "" : null !== l ? (m = l.attributeName, l = l.type, n = 3 === l || 4 === l && !0 === n ? m + '=""' : m + "=" + ('"' + M(n) + '"')) : n = qa(m) ? m + "=" + ('"' + M(n) + '"') : "";
          }n && (B += " " + n);
        }
      }g || D && (B += ' data-reactroot=""');var y = B;h = "";Da.hasOwnProperty(b) ? y += "/>" : (y += ">", h = "</" + a.type + ">");a: {
      ...
      }null != g ? (e = [], Ja[b] && "\n" === g.charAt(0) && (y += "\n"), y += g) : e = Z(e.children);a = a.type;c = null == c || "http://www.w3.org/1999/xhtml" === c ? Ca(a) : "http://www.w3.org/2000/svg" === c && "foreignObject" === a ? "http://www.w3.org/1999/xhtml" : c;this.stack.push({ domNamespace: c, type: b, children: e, childIndex: 0, context: d, footer: h });this.previousWasTextNode = !1;return y;
    };return a;
  }(),
      Ta = { renderToString: function (a) {
      a = new Sa(a, !1);try {
    ...
    version: "16.8.6" },
      Ua = { default: Ta },
      Va = Ua && Ta || Ua;module.exports = Va.default || Va;
});
