...
Liferay.Loader.define('liferay-js-toolkit-showcase$react-dom@16.8.6/cjs/react-dom-unstable-fire.development', ['module', 'exports', 'require', 'liferay-js-toolkit-showcase$react', 'liferay-js-toolkit-showcase$object-assign', 'liferay-js-toolkit-showcase$prop-types/checkPropTypes', 'liferay-js-toolkit-showcase$scheduler', 'liferay-js-toolkit-showcase$scheduler/tracing'], function (module, exports, require) {
  var define = undefined;

  (function () {
    'use strict';

    var React = require('liferay-js-toolkit-showcase$react');
    var _assign = require('liferay-js-toolkit-showcase$object-assign');
    var checkPropTypes = require('liferay-js-toolkit-showcase$prop-types/checkPropTypes');
    var scheduler = require('liferay-js-toolkit-showcase$scheduler');
    var tracing = require('liferay-js-toolkit-showcase$scheduler/tracing');
    ...
    function getHostProps(element, props) {
      ...
      var hostProps = _assign({}, props, {
        ...
        value: undefined,
        checked: checked != null ? checked : element._wrapperState.initialChecked
      });
    ...
    function releaseTopLevelCallbackBookKeeping(instance) {
      ...
      if (callbackBookkeepingPool.length < 10) {
     ...
     */
    injection.injectEventPluginOrder(['ResponderEventPlugin', 'SimpleEventPlugin', 'EnterLeaveEventPlugin', 'ChangeEventPlugin', 'SelectEventPlugin', 'BeforeInputEventPlugin']);
    ...
    function restoreControlledState$2(element, props) {
      ...
      if (value != null) {
        updateOptions(element, !!props.multiple, value, false);
      }
    }
    ...
    function assertValidProps(tag, props) {
      ...
      if (props.dangerouslySetInnerHTML != null) {
        ...
        !(typeof props.dangerouslySetInnerHTML === 'object' && '__html' in props.dangerouslySetInnerHTML) ? invariant(false, '`props.dangerouslySetInnerHTML` must be in the form `{__html: ...}`. Please visit https://fb.me/react-invariant-dangerously-set-inner-html for more information.') : void 0;
      }
      {
    ...
    function prepareUpdate(domElement, type, oldProps, newProps, rootContainerInstance, hostContext) {
      {
        if (typeof newProps.children !== typeof oldProps.children && (typeof newProps.children === 'string' || typeof newProps.children === 'number')) {
          ...
          var ownAncestorInfo = updatedAncestorInfo(hostContext.ancestorInfo, type);
          validateDOMNesting(null, string, ownAncestorInfo);
        }
      }
    ...
    function computeAsyncExpiration(currentTime) {
      return computeExpirationBucket(currentTime, LOW_PRIORITY_EXPIRATION, 250);
    }
    ...
    function dispatchAction(fiber, queue, action) {
      !(numberOfReRenders < 25) ? invariant(false, 'Too many re-renders. React limits the number of renders to prevent an infinite loop.') : void 0;
    ...
    function commitBeforeMutationLifeCycles(current$$1, finishedWork) {
      switch (finishedWork.tag) {
        ...
        case SimpleMemoComponent:
          {
            commitHookEffectList( /*      */2, NoEffect$1, finishedWork);
            return;
          }
        case ClassComponent:
          {
    ...
    function commitLifeCycles(finishedRoot, current$$1, finishedWork, committedExpirationTime) {
      switch (finishedWork.tag) {
        ...
        case SimpleMemoComponent:
          {
            commitHookEffectList( /*        */16, MountLayout, finishedWork);
            break;
          }
        case ClassComponent:
          {
        ...
        case SimpleMemoComponent:
          {
            ...
            // UnmountMutation.
            commitHookEffectList(UnmountMutation, /*        */8, finishedWork);
            return;
          }
        case ClassComponent:
          {
        ...
        do {
          if (_workInProgress.tag === SuspenseComponent && shouldCaptureSuspense(_workInProgress)) {
            ...
            if ((_workInProgress.mode & ConcurrentMode) === NoEffect) {
              ...
              sourceFiber.effectTag &= ~( /*   */932 | Incomplete);
    ...
    function renderRoot(root, isYieldy) {
      ...
      if (didFatal) {
        stopWorkLoopTimer(interruptedBy, false);
        interruptedBy = null;
      ...
      stopWorkLoopTimer(interruptedBy, true);
      ...
      if (nextRenderDidError) {
        ...
        if (hasLowerPriorityWork(root, expirationTime)) {
          ...
          var rootExpirationTime = root.expirationTime;
          onSuspend(root, rootWorkInProgress, expirationTime, rootExpirationTime, -1 // Indicates no timeout
          );
          return;
        } else if (
    ...
    function scheduleCallbackWithExpirationTime(root, expirationTime) {
      ...
      callbackID = scheduler.unstable_scheduleCallback(performAsyncWork, { timeout: expirationTimeMs - currentMs });
    }
    ...
    })(batchedUpdates$1, interactiveUpdates$1, flushInteractiveUpdates$1);
    ...
    var ReactDOM = {
      ...
      unstable_createRoot: function createRoot(container, options) {
        !isValidContainer(container) ? invariant(false, '%s(...): Target container is not a DOM element.', 'unstable_createRoot') : void 0;
        {
      ...
      __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: {
        ...
        Events: [getInstanceFromNode$1, getNodeFromInstance$1, getFiberCurrentPropsFromNode$1, injection.injectEventPluginsByName, eventNameDispatchConfigs, accumulateTwoPhaseDispatches, function accumulateDirectDispatches(events) {
          forEachAccumulated(events, accumulateDirectDispatchesSingle);
        }, enqueueStateRestore, restoreStateIfNeeded, dispatchEvent, runEventsInBatch]
      }
    };
...
//# sourceMappingURL=react-dom-unstable-fire.development.js.map