...
Liferay.Loader.define('liferay-js-toolkit-showcase$react-dom@16.8.6/umd/react-dom-test-utils.development', ['module', 'exports', 'require', 'liferay-js-toolkit-showcase$react', 'liferay-js-toolkit-showcase$react-dom'], function (module, exports, require) {
  var define = undefined;
  (function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('liferay-js-toolkit-showcase$react'), require('liferay-js-toolkit-showcase$react-dom')) : typeof define === 'function' && define.amd ? define(['react', 'react-dom'], factory) : global.ReactTestUtils = factory(global.React, global.ReactDOM);
    ...
    _ReactDOM$__SECRET_IN[1];
    _ReactDOM$__SECRET_IN[2];
    _ReactDOM$__SECRET_IN[3];
    ...
    function findAllInRenderedFiberTreeInternal(fiber, test) {
      ...
      var ret = [];
      while (true) {
        if (node.tag === 5 || node.tag === 6 || node.tag === 1 || node.tag === 0) {
