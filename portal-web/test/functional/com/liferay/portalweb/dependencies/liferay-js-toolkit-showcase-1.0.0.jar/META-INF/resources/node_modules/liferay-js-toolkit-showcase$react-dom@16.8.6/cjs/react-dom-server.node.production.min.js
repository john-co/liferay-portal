...
'use strict';
Liferay.Loader.define("liferay-js-toolkit-showcase$react-dom@16.8.6/cjs/react-dom-server.node.production.min", ['module', 'exports', 'require', 'liferay-js-toolkit-showcase$object-assign', 'liferay-js-toolkit-showcase$react', 'liferay-js-toolkit-showcase$stream'], function (module, exports, require) {
  var define = undefined;
  var p = require("liferay-js-toolkit-showcase$object-assign"),
      q = require("liferay-js-toolkit-showcase$react"),
      aa = require("liferay-js-toolkit-showcase$stream");function ba(a, b, d, c, f, e, h, g) {
    if (!a) {
  ...
  function r(a) {
    for (var b = arguments.length - 1, d = "https://reactjs.org/docs/error-decoder.html?invariant=" + a, c = 0; c < b; c++) d += "&args[]=" + encodeURIComponent(arguments[c + 1]);ba(!1, "Minified React error #" + a + "; visit %s for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ", d);
  }
  ...
  function C(a) {
    if (null == a) return null;if ("function" === typeof a) return a.displayName || a.name || null;if ("string" === typeof a) return a;switch (a) {case ha:
        ...
        return "Suspense";}if ("object" === typeof a) switch (a.$$typeof) {case fa:
  ...
  var X = 0,
    ...
    }, useReducer: ya, useRef: function (a) {
  ...
  function Sa(a, b, d) {
    function c(c, f) {
      ...
      } else g = null;a = k.render();Ra(a, f);c = void 0;if ("function" === typeof k.getChildContext && (e = f.childContextTypes, "object" === typeof e)) {
    ...
    function a(b, d) {
      ...
      if (null === a || !1 === a) return "";if (!q.isValidElement(a)) {
        if (null != a && null != a.$$typeof) {
          ...
          r("294");}if ("object" === typeof b && null !== b) switch (b.$$typeof) {case ia:
      ...
      }if (h = e) Fa[b] && (null != h.children || null != h.dangerouslySetInnerHTML ? r("137", b, "") : void 0), null != h.dangerouslySetInnerHTML && (null != h.children ? r("60") : void 0, "object" === typeof h.dangerouslySetInnerHTML && "__html" in h.dangerouslySetInnerHTML ? void 0 : r("61")), null != h.style && "object" !== typeof h.style ? r("62", "") : void 0;h = e;g = this.makeStaticMarkup;
      D = 1 === this.stack.length;B = "<" + a.type;for (y in h) if (Pa.call(h, y)) {
        var l = h[y];if (null != l) {
          if ("style" === y) {
            n = void 0;var k = "",
  ...
  var Va = function (a) {
    function b(d, c) {
      if (!(this instanceof b)) throw new TypeError("Cannot call a class as a function");var f = a.call(this, {});if (!this) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");f = !f || "object" !== typeof f && "function" !== typeof f ? this : f;f.partialRenderer = new Ta(d, c);return f;
